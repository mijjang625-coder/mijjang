        ...
        >
          ...
          <Section title="리뷰 분석 & 마케팅 문구 자동생성" emoji="🧠" collapsible defaultCollapsed flat forceCollapsed={allCollapsed}>
            ...
            <ReviewAnalyzer
              ...
              initialSnapshot={reviewAnalyzerSnapshot}
              onStateSnapshotChange={setReviewAnalyzerSnapshot}
            ...
            <Field label="제품 유형">
              ...
              {brief.productType && (
                <div className="text-[11px] mt-1.5 px-2 py-1.5 rounded" style={{ backgroundColor: '#FFF8F0', borderLeft: '3px solid #FDBA74', color: '#9A3412' }}>
                  ✨ <b>{brief.productType}</b> 카테고리 프리셋 적용 중 — 카피 톤 + 디자인 테마/카드 스타일이 카테고리에 맞게 자동 조정됩니다. 기본 폰트는 Pretendard를 유지합니다.
                </div>
              )}
            </Field>
